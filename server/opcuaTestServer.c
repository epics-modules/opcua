...
void *simVariable(void *ptr) {
    ...
    while(running) {
        ...
        UA_Server_writeValue(server, UA_NODEID_STRING((*(&threadParams->ns))[1], "0:\\\\Test-01"), value);
...
int main(void) {
    ...
    /* Add simulation NodeSet (subset of CFHVMS nodes) */
    UA_StatusCode retval = cfhvmsNodeSet(server, ns);
